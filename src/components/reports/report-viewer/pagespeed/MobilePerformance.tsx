...
const MobilePerformance: React.FC<MobilePerformanceProps> = ({ data }) => {
  if (!data) {
    return <p className="text-muted-foreground">No hay datos disponibles para mobile.</p>;
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <h3 className="text-lg font-medium">Métricas de rendimiento (Mobile)</h3>
