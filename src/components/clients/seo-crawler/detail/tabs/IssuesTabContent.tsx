...
import { AlertTriangle, Search, AlertCircle, Info, CheckCircle, ExclamationTriangle } from 'lucide-react';
...
const IssuesTabContent: React.FC<IssuesTabContentProps> = ({
  ...
  const getSeverityIcon = (severity: string) => {
    switch (severity) {
      ...
      case 'medium':
        return <ExclamationTriangle className="h-4 w-4 text-yellow-500" />;
      case 'low':
